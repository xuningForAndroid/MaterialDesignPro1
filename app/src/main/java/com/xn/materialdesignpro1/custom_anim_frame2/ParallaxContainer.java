		...
		if (inFragment != null) {
			...
			if (inViews != null) {
				for (View view : inViews) {
					...
					ViewCompat.setTranslationX(view,(containerWidth - positionOffsetPixels) * tag.xIn);
					ViewCompat.setTranslationY(view, (containerWidth - positionOffsetPixels) * tag.yIn);
				}
			}
		}
		...
		if(outFragment != null){
			...
			if (outViews != null) {
				for (View view : outViews) {
					...
					ViewCompat.setTranslationX(view,0 - positionOffsetPixels * tag.xOut);
					ViewCompat.setTranslationY(view,  0 - positionOffsetPixels * tag.yOut);
				}
			}
		}
