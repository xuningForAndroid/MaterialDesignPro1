...
public class SearchView extends View {
    ...
    // 当前的状态(非常重要)
    private static int mCurrentState = NONE;
    ...
    // 控制各个过程的动画
    private static ValueAnimator mStartingAnimator;
    private static ValueAnimator mSearchingAnimator;
    private static ValueAnimator mEndingAnimator;
    ...
    // 用于控制动画状态转换
    private  MyHandler mAnimatorHandler;
    ...
    private void initHandler() {
        ...
        mAnimatorHandler = new MyHandler() ;
    }
