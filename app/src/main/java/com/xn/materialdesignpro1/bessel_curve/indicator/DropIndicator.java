...
public class DropIndicator extends ViewGroup {
    ...
    public DropIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        roundColors[1] = typedArray.getColor(R.styleable.DropIndicator_color2, Color.parseColor("#B04285F4"));
        roundColors[2] = typedArray.getColor(R.styleable.DropIndicator_color3, Color.parseColor("#B04285F4"));
        roundColors[3] = typedArray.getColor(R.styleable.DropIndicator_color4, Color.parseColor("#B04285F4"));
        ...
        radius = typedArray.getDimension(R.styleable.DropIndicator_radius, 10);
